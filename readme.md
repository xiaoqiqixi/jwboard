...
当前正式版本：`JWBoard 1.0.3`（发布标签：`jwboard1.0.3`；首发版本标签为 `jwboard1.0`）
...
| --- | --- | --- |
| 1.0.0 | 1.0.3 | 依次执行 `1.0.1.sql`、`1.0.2.sql`、`1.0.3.sql` |
| 1.0.2 | 1.0.3 | 只执行 `1.0.3.sql` |
| 1.0.3 | 1.0.3 | 不重复执行数据库 SQL，只刷新依赖与服务 |
